...
namespace KBEngine
{
	...
	public struct CARDID
	{
		...
		public static implicit operator UInt64(CARDID value)
		{
			return value.value;
		}
	...
	{
		public UInt64 CardID = 0;
		public Byte CardNum = 0;

	}

	public class OPEN_PACK_RUL : List<UInt64>
	{
	...
	public class CARDGROUP_INFO_LIST : List<CARDGROUP_INFO>
	{
