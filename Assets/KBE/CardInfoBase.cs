/*
	...
	Please inherit this module, such as: (class CardInfo : CardInfoBase)
	tools = kbcmd
*/
...
namespace KBEngine
{
	...
	// Please inherit and implement "class CardInfo : CardInfoBase"
	public abstract class CardInfoBase : Entity
	{
		public EntityBaseEntityCall_CardInfoBase baseEntityCall = null;
		public EntityCellEntityCall_CardInfoBase cellEntityCall = null;
		...
		{
			baseEntityCall = new EntityBaseEntityCall_CardInfoBase(id, className);
		}
